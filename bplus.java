...
public class bplus {
    ...
    static int countno() throws FileNotFoundException, IOException{
        ...
        no1=0;
        try {
            File fle = new File("/Users/shreya/Desktop/bplus.txt");
        ...
        BufferedReader reader = new BufferedReader(new FileReader("/Users/shreya/Desktop/bplus.txt"));
        String line;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i=0;i<no;i++)
            recs[i]=new records();
        BufferedReader bbr = new BufferedReader(new FileReader("/Users/shreya/Desktop/bplus.txt"));
        for(int i=0;i<no;i++)
        {
        ...
        while(true)
        {
            System.out.print("************  Welcome to VACCINE MANAGEMENT SYSTEM ************** \n");
            ...
            {
                case 1:
                    System.out.print("Enter The Unique Patient ID: ");
                    key=sc.nextInt();
                    b.insert(key);
...
//TRY TO FIND HOW TO WRITE OBJECTS INTO A FILE
                    try {
                        FileWriter fw=new FileWriter("/Users/shreya/Desktop/bplus.txt",true);
                        fw.write(""+key);
                        fw.write("|");
                        fw.write(name);
                        fw.write("|");
                    ...
                    no++;
                    break;
                case 2: System.out.print("Enter The patient ID to be searched: ");
                    key=sc.nextInt();
